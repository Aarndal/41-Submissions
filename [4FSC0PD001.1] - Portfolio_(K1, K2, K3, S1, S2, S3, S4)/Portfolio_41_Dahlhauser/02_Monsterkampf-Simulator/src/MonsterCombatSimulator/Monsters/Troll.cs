...
namespace Monster_Combat_Simulator.Monsters
{
    ...
    {
        private static readonly Boundaries m_healthBoundaries = new(16, 25);
        private static readonly Boundaries m_attackBoundaries = new(11, 16);
        private static readonly Boundaries m_defenseBoundaries = new(1, 5);
