...
namespace Monster_Combat_Simulator
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            "Hit Points: ".Write();
            float hp01 = float.Parse(TextInput().Trim());
            "Attack Power: ".Write();
            float ap01 = float.Parse(TextInput().Trim());
            "Defense Points: ".Write();
            float dp01 = float.Parse(TextInput().Trim());
            "Speed: ".Write();
            float s01 = float.Parse(TextInput().Trim());
            ...
            "Hit Points: ".Write();
            float hp02 = float.Parse(TextInput().Trim());
            "Attack Power: ".Write();
            float ap02 = float.Parse(TextInput().Trim());
            "Defense Points: ".Write();
            float dp02 = float.Parse(TextInput().Trim());
            "Speed: ".Write();
            float s02 = float.Parse(TextInput().Trim());
